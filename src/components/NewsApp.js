...
export const NewsApp = () => {
    ...
    const fetchNews = async (page, q) => {
        ...
        const url = `https://newsapi.org/v2/everything?q=${q}&from=2024-07-20&pageSize=20&language=en&page=${page}&sortBy=popularity&apiKey=b3f8d5b146be4afd88811b2737c399be`;
    ...
    const downloadArticle = (article) => {
        ...
        const file = new Blob([`Title: ${article.title}\n\nDescription: ${article.description}\n\nContent: ${article.content}\n\nURL: ${article.url}`], { type: 'text/plain' });
    ...
    return (
        ...
        <div className="container">
            ...
            <a className={`nav-link ${selectedCategory === "sport" ? "active" : ""}`} onClick={() => setSelectedCategory("sport")} href="#">Sport</a>
         
          
            <a className={`nav-link ${selectedCategory === "gaming" ? "active" : ""}`} onClick={() => setSelectedCategory("gaming")} href="#">Gaming</a>
        
          
            <a className={`nav-link ${selectedCategory === "politics" ? "active" : ""}`} onClick={() => setSelectedCategory("politics")} href="#">Politics</a>
          
         
            <a className={`nav-link ${selectedCategory === "weather" ? "active" : ""}`} onClick={() => setSelectedCategory("weather")} href="#">Weather</a>
        
            <a href="javascript:void(0);" className="icon" onClick={handleToggle} aria-label="Toggle navigation menu">
                        ...
                        {article.map((item, index) => (
                            <div class="card" key={index}>
                                ...
                                <div className="card-body">
                                    ...
                                    <h5 color="white" className="card-title">{item.title.slice(0, 23)}</h5>
                                    <p  color="white" className="card-text">{item.description.slice(0, 60)}...</p>
                                    ...
                                    <div className="download">
                                        <button onClick={() => downloadArticle(item)} className="btn btn-secondary mt-2">Save for offline
