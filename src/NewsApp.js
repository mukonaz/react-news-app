...
const NewsApp = () => {
    ...
    const fetchNews = async (page, q) => {
        ...
        const url = `https://newsapi.org/v2/everything?q=${q}&from=2024-08-01&pageSize=20&language=en&page=${page}&sortBy=popularity&apiKey=b3f8d5b146be4afd88811b2737c399be`;
...
const downloadArticle = (article) => {
    ...
    element.download = `${article.url}.txt`;
    ...
    return (
        <div className="container">
            <h1 className='news-title'>News App</h1>
            ...
            {view === "news" ? (
                <>
                    ...
                    <form onSubmit={handleSearch}>
                        <input type="text" value={searchInput} onChange={(e) => setSearchInput(e.target.value)} placeholder="Search for news" className="searchTerm"/>
                        ...
                        {article.map((item, index) => (
                            <div key={index} className="card my-4 mx-2" style={{ width: '18rem', position: 'relative' }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <a href={item.url} target="_blank" rel="noopener noreferrer" className="btn-primary">Read Article</a>
                                    <p>Share this:</p>
                                    ...
                                    <div className="download">
                                        <button onClick={() => downloadArticle(item)} className="btn btn-secondary mt-2">Save for offline</button>
                                    </div>
